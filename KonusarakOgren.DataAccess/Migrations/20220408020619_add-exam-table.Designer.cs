...
namespace KonusarakOgren.DataAccess.Migrations
{
    ...
    [Migration("20220408020619_add-exam-table")]
            ...
            modelBuilder.Entity("KonusarakOgren.Entity.SqlLiteKonusarakOgren.Entities.Article.Article", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = 1,
                            CreatedOn = new DateTime(2022, 4, 8, 2, 6, 19, 81, DateTimeKind.Utc).AddTicks(4675),
                            IsDeleted = false,
                            ...
                            UpdatedBy = 1,
                            UpdatedOn = new DateTime(2022, 4, 8, 2, 6, 19, 81, DateTimeKind.Utc).AddTicks(4677)
                        },
                        new
                        {
                            Id = 2,
                            CreatedBy = 1,
                            CreatedOn = new DateTime(2022, 4, 8, 2, 6, 19, 81, DateTimeKind.Utc).AddTicks(4680),
                            IsDeleted = false,
                            ...
                            UpdatedBy = 1,
                            UpdatedOn = new DateTime(2022, 4, 8, 2, 6, 19, 81, DateTimeKind.Utc).AddTicks(4681)
                        },
                        new
                        {
                            Id = 3,
                            CreatedBy = 1,
                            CreatedOn = new DateTime(2022, 4, 8, 2, 6, 19, 81, DateTimeKind.Utc).AddTicks(4681),
                            IsDeleted = false,
                            ...
                            UpdatedBy = 1,
                            UpdatedOn = new DateTime(2022, 4, 8, 2, 6, 19, 81, DateTimeKind.Utc).AddTicks(4682)
                        },
                        new
                        {
                            Id = 4,
                            CreatedBy = 1,
                            CreatedOn = new DateTime(2022, 4, 8, 2, 6, 19, 81, DateTimeKind.Utc).AddTicks(4682),
                            IsDeleted = false,
                            ...
                            UpdatedBy = 1,
                            UpdatedOn = new DateTime(2022, 4, 8, 2, 6, 19, 81, DateTimeKind.Utc).AddTicks(4683)
                        },
                        new
                        {
                            Id = 5,
                            CreatedBy = 1,
                            CreatedOn = new DateTime(2022, 4, 8, 2, 6, 19, 81, DateTimeKind.Utc).AddTicks(4683),
                            IsDeleted = false,
                            ...
                            UpdatedBy = 1,
                            UpdatedOn = new DateTime(2022, 4, 8, 2, 6, 19, 81, DateTimeKind.Utc).AddTicks(4684)
                        });
                });

            modelBuilder.Entity("KonusarakOgren.Entity.SqlLiteKonusarakOgren.Entities.Exam.Exam", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("KonusarakOgren.Entity.SqlLiteKonusarakOgren.Entities.User.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = 1,
                            CreatedOn = new DateTime(2022, 4, 8, 2, 6, 19, 81, DateTimeKind.Utc).AddTicks(5166),
                            ...
                            Type = 1,
                            UpdatedBy = 1,
                            UpdatedOn = new DateTime(2022, 4, 8, 2, 6, 19, 81, DateTimeKind.Utc).AddTicks(5168)
                        },
                        new
                        {
                            Id = 2,
                            CreatedBy = 1,
                            CreatedOn = new DateTime(2022, 4, 8, 2, 6, 19, 81, DateTimeKind.Utc).AddTicks(5168),
                            ...
                            Type = 2,
                            UpdatedBy = 1,
                            UpdatedOn = new DateTime(2022, 4, 8, 2, 6, 19, 81, DateTimeKind.Utc).AddTicks(5169)
                        });
                });
            ...
            modelBuilder.Entity("KonusarakOgren.Entity.SqlLiteKonusarakOgren.Entities.Exam.Exam", b =>
                {
                    ...
                    b.HasOne("KonusarakOgren.Entity.SqlLiteKonusarakOgren.Entities.User.User", "User")
                        .WithMany("Exams")
